        ...
        return(
            ...
            <div id="home">
                        <div className="container-fluid row my-3 ">
                            <div className="col p-0 d-flex foto" id="shop" onClick={()=>{window.scrollTo(0, 0);navigate(paths.shop)}}>
                            ...
                            <div className="col p-0 d-flex foto" id="contact" onClick={()=>{navigate(paths.contact)}}>
                            <div className="shadow"></div>
                            <div className="d-flex flex-column my-auto mx-auto">
                            ...
                            <div className="col p-0 d-flex foto" id="offices" onClick={()=>{navigate(paths.offices)}}>
                            <div className="shadow"></div>
                            <div className="d-flex flex-column my-auto mx-auto">
